<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['karyawan']) }}">
        <a href="{{ url('/karyawan') }}" class="nav-link">
          <i class="link-icon" data-feather="users"></i>
          <span class="link-title">Karyawan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['absensi']) }}">
      ...
      <li class="nav-item {{ active_class(['payroll/*']) }}">
        <a class="nav-link" data-bs-toggle="collapse" href="#payroll" role="button" aria-expanded="{{ is_active_route(['payroll/*']) }}" aria-controls="advanced-ui">
          <i class="link-icon" data-feather="dollar-sign"></i>
          <span class="link-title">Payroll</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['payroll/*']) }}" id="payroll">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/payroll/cropper') }}" class="nav-link {{ active_class(['payroll/cropper']) }}">Run Payroll</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/payroll/owl-carousel') }}" class="nav-link {{ active_class(['payroll/owl-carousel']) }}">THR</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/payroll-component') }}" class="nav-link {{ active_class(['payroll-component']) }}">Payroll Component</a>
            </li>
          </ul>
        </div>
      </li>

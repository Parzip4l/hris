    ...
    <div class="card">
      <div class="card-body">
        <div class="head-card d-flex justify-content-between mb-3">
            ...
            <a class="btn btn-primary d-flex align-items-center" href="{{ route('pengumuman.create') }}"><i data-feather="plus" class="icon-sm me-2"></i> <span class="">Tambah Pengumuman</span></a>
        </div>
        <hr>
              ...
              <tr>
                ...
                <td>
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      ...
                      <form action="{{ route('pengumuman.destroy', $data->id) }}" method="POST" id="delete_warga">
                      @csrf
                      @method('DELETE')

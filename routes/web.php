...
Route::resource('/employee', \App\Http\Controllers\EmployeedashboardController::class);
...
// Payroll
Route::get('/payroll', 'PayrollController@showPayroll')->name('showPayroll');
Route::get('/payroll/calculate', 'PayrollController@showPayroll')->name('calculatePayroll');
Route::post('/payroll', 'PayrollController@storePayroll')->name('storePayroll');


// Payroll Component
Route::resource('/payroll-component', \App\Http\Controllers\PayrollComponentController::class);

// Absen
Route::post('/absensi/clockin', [\App\Http\Controllers\AbsensiController::class, 'clockin'])
->middleware('auth')
->name('clockin');

Route::post('/absensi/clockout', [\App\Http\Controllers\AbsensiController::class, 'clockout'])
->middleware('auth')
->name('clockout');

// Profile
Route::resource('/myprofile', \App\Http\Controllers\EmployeeprofileController::class);
Route::resource('/mylogs', \App\Http\Controllers\EmployeelogController::class);
Route::resource('/myslip', \App\Http\Controllers\EmployeeslipController::class);

Route::get('/mylogs', 'EmployeelogController@index')->name('mylogs');
